...
function(t, e) {
	...
	var Ot = ht && window.CSS && CSS.escape ||
	function(t) {
	...
	le.resolve = function(t) {
		...
		var o = this;
		he(function() {
			if (o.state !== ue) for (; o.deferred.length;) {
	...
	function Nn(e, n, i) {
		var r = {};
		if ($(n) && (n = n.options), n.extends && (e = Nn(e, n.extends, i)), n.mixins) for (var t = 0, o = n.mixins.length; t < o; t++) e = Nn(e, n.mixins[t], i);
		for (var s in e) u(s);
	...
	var Zn = ht && window.IntersectionObserver ||
	function() {
		function t(e, t) {
			var n = this;
			void 0 === t && (t = {});
	...
	ti.util = Object.freeze({
		...
		(t = t || {}).data = function(t, e) {
			...
			}, {}) : n) for (var o in n) H(n[o]) ? delete n[o] : n[o] = r[o] ? fi(r[o], n[o]) : n[o];
			return n
	...
	function Ci(t, e, n) {
		for (var i = [
			...
			var o = t[r];
			if (Ft(o)) for (var s = Ai(o), a = i.length - 1; 0 <= a; a--) {
				var u = i[a];
				if (!u[0]) {
					u.push(o);
					break
			...
			update: [{
				...
				write: function(t, e) {
					...
					var o = t.dir,
						...
						u = t.scroll,
						h = t.top;
					if (!((t.lastScroll = u) < 0 || u === a && "scroll" === e || this.showOnUp && "scroll" !== e && !this.isFixed || ((300 < i - r || o !== s) && (t.initScroll = u, t.initTimestamp = i), t.lastDir = o, this.showOnUp && !this.isFixed && Math.abs(t.initScroll - u) <= 30 && Math.abs(a - u) <= 10))) if (this.inactive || u < this.top || this.showOnUp && (u <= this.top || "down" === o && "scroll" === e || "up" === o && !this.isFixed && u <= this.bottomOffset)) {
					...
					} else this.isFixed ? this.update() : this.animation ? (rn.cancel(this.$el), this.show(), rn. in (this.$el, this.animation).
					catch (et)) : this.show()
				},
				events: ["resize", "scroll"]
			}],
	...
	K(Object.freeze({
		...
		new MutationObserver(function(t) {
			var r = [];
			t.forEach(function(t) {
				return n = r, i = (e = t).target, void(("attributes" !== e.type ?
				function(t) {
			...
			events: [{
				...
				handler: function(t) {
					var e = t.type,
						...
						o = n.timing,
						s = n.dir;
					Qe.cancel(this.$el), Re(this.$el, this.getCss(yo(e, s, i))), Qe.start(this.$el, this.getCss(xo(e) ? .5 : 0 < s ? 1 : 0), r, o).
					catch (et)
				}
			}, {
